    ...
    <div>
      ...
      <div className="mx-2">
        <form ref={formRef} onSubmit={sendEmail} className="flex flex-col gap-4 mt-4">
          <input type="text" placeholder="Name*" name="name" className={commonClass} required />
          <input type="email" placeholder="Email*" name="email" className={commonClass} required />
          <input type="text" placeholder="Location*" name="location" className={commonClass} required />
          <input type="text" placeholder="Subject*" name="title" className={commonClass} required />
          <textarea placeholder="Message*" name="message" className={commonClass} required />
          <button
            type="submit"
